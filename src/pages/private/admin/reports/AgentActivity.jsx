    ...
    try {
      ...
      if (period === 'daily') {
        ...
        if (period === 'weekly') {
          ...
          // For custom month, show all days of that month (up to 31 or today if current month)
        ...
        // Fetch each agent's history and build rows
        for (const agent of dataToExport) {
          ...
          // Create activity map from dailyActivities
          const activityMap = {};
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground ">{agent.employee_id}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
