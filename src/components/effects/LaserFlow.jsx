...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    const setSizeNow = () => {
      // Prefer container size, but fall back to viewport to guarantee full-screen coverage
      let w = mount.clientWidth;
      let h = mount.clientHeight;
      if (!w || w < 2) w = (typeof window !== 'undefined' ? window.innerWidth : 0) || 1;
      if (!h || h < 2) h = (typeof window !== 'undefined' ? window.innerHeight : 0) || 1;
  ...
  ro.observe(mount);
  // Also respond to viewport resizes (useful when running full-screen)
